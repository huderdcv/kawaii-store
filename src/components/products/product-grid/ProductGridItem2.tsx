    ...
    <div className="max-w-sm min-h-[400px] bg-[#FFF4DC] rounded-2xl shadow-xl overflow-hidden transition hover:scale-105 hover:shadow-2xl font-sans flex flex-col">
      ...
      <div className="p-2 flex flex-col flex-1">
        ...
        <div className="mt-auto">
          <button className="mt-3 w-full bg-[#FF7C00] hover:bg-[#FFD700] text-white font-medium py-1.5 rounded-xl shadow-sm transition flex justify-center items-center gap-2 text-sm">
            Agregar al carrito
            <svg
              className="w-4 h-4"
              fill="none"
